...
class ReponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reponses = $em->getRepository('wcshackathonBundle:Reponse')->findAll();
    ...
    {
        $reponse = new Reponse();
        $form = $this->createForm('wcs\hackathonBundle\Form\ReponseType', $reponse);
    ...
    {
        $deleteForm = $this->createDeleteForm($reponse);
        $editForm = $this->createForm('wcs\hackathonBundle\Form\ReponseType', $reponse);
